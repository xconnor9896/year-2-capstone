            ...
            <div className="report-info">
              <article className={styles.basicInfo}>
                ...
                <section>
                  ...
                  <div>
                    <span>
                      <label>
                        Responsible Officer (Rank Last, First Middle Name)
                      </label>
                      <p>
                ...
                <section>
                  ...
                  <div>
                    <span>
                      ...
                      <ul>
                        {Object.entries(hospitalInfo.treatmentReasons).map(
                          (reason, index) => {
                            const reasonTitles = [
                              "Mental",
                              "Suicide",
              ...
              return (
                <div className={styles.personInfo}>
                  <article key={_id}>
                    <section>
                      <header>Person {!onlyPerson && <>#{key + 1}</>}</header>
                    </section>
                    <section>
                      <div>
                        <span>
        ...
        <div className={`${styles.page} ${styles.continuationPage}`}>
          ...
          <article>
            ...
            <section>
              ...
              <div>
                <span>
                  <label>Complainant (Last, First Middle Name)</label>
                  <p>
                    {basicInfo.responsibleOfficer.name.lastName},{" "}
                    {basicInfo.responsibleOfficer.name.firstName}{" "}
                    {basicInfo.responsibleOfficer.name.middleName}
        ...
        <section>
          <div>
            ...
            <span>
              ...
              <b>
                <span>RANK:</span> {basicInfo.responsibleOfficer.rank}
              </b>
              <b>
                <span>Date/Time:</span>{" "}
                {basicInfo.incidentReportedAt.date.month}/
                  ...
                  <b>
                    ...
                    {activeReport.approvedBy.rank[0].toUpperCase() +
                      activeReport.approvedBy.rank.slice(
                        1,
                        activeReport.approvedBy.rank.length
                      )}
                  </b>
                  <b>
                    <span>Date/Time:</span> {activeReport.approvedAt.date.month}
